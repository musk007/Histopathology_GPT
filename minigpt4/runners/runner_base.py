...
class RunnerBase:
    ...
    def dataloaders(self) -> dict:
        ...
        if self._dataloaders is None:
            ...
            self.datasets = datasets    # a dictionary
            ...
            # print("length of datasets ",len(datasets), len(datasets[0][0]))
    ...
    def train(self):
        ...
        for cur_epoch in range(self.start_epoch, self.max_epoch):
            ...
            if cur_epoch == self.max_epoch - 1:
                ...
                wandb.save(os.path.join(self.output_dir, "checkpoint_{}.pth".format(cur_epoch)))
    ...
    def evaluate(self, cur_epoch="best", skip_reload=False):
        ...
        if len(self.test_splits) > 0:
            for split_name in self.test_splits:
                test_logs[split_name] = self.inference()
    ...
    def eval_epoch(self, split_name, cur_epoch, skip_reload=False):
        ...
        results = self.task.inference(model, data_loader)
    ...
    def _reload_best_model(self, model):
        ...
        """
        checkpoint_path = "/l/users/roba.majzoub/prerained_minigpt4_7b.pth"
